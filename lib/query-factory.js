...
class QueryFactory {
   ...
   */
  createBuilder(...args) {
    return this.registry.createInstance('builder', args, QueryBuilder)
  }
   ...
   */
  createParser(...args) {
    return this.registry.createInstance('parser', args, QueryParser)
  }
   ...
   */
  createVisitor(...args) {
    return this.registry.createInstance('visitor', args, QueryVisitor)
  }
  ...
  createInterpreter(visitor, ...args) {
    ...
    return this.registry.createInstance('interpreter', [visitor, ...args], QueryInterpreter)
  }
}
